...
def second_page():
    ...
    with st.expander(':pill: :blue[開始吃健安心的時候的用藥狀況]'):
    ...
    with st.expander(':1234: :orange[現在的整體狀況]'):
        current_hb = None
    ...
    with st.expander(':microbe: :red[現在的用藥狀況]'):
...
def second_page_en():
    ...
    with st.expander(':pill: :blue[Baseline Drug Use]'):
    ...
    with st.expander(':1234: :orange[Current Status]'):
        current_hb = None
    ...
    with st.expander(':microbe: :red[Current Drug Use]'):
